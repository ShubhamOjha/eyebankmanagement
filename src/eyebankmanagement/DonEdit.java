...
/**
 * Servlet implementation class DonEdit
 */
@WebServlet("/DonEdit")
public class DonEdit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String strupdate="update donor set email=?,phoneno=?,address=?,fname=?,mname=? where donorid=?";
		...
		if(rw>0)
		{
			...
			response.sendRedirect("/eyebankmanagement/jsp/report.jsp");
